  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50">
      <div className="container">
        <nav
          className={`mt-4 flex items-center justify-between rounded-full border px-5 py-3 transition-all ${
            scrolled
              ? "border-border bg-background/80 backdrop-blur-xl shadow-elegant"
        ...
        >
          ...
          <a
            href="#contact"
            className="hidden md:inline-flex text-sm font-medium px-4 py-2 rounded-full bg-gradient-primary text-primary-foreground hover:scale-[1.02] transition-transform shadow-glow"
          >
            Get a free quote
          </a>
          <button
